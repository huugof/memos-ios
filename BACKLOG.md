...
### Rethink notes screen design
More thinking needed about the notes screen — layout, UX, overall feel.
...
Add quick tag-based navigation/filtering to the notes screen.
...
### Better hit target for new notes
The tap target for creating new notes needs to be larger/easier to hit.
